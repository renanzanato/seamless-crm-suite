...
const stages = [
  { label: "Contatos", value: 1248, width: "100%" },
  { label: "Qualificados", value: 486, width: "72%" },
  { label: "Visitas", value: 198, width: "48%" },
  { label: "Propostas", value: 87, width: "30%" },
  { label: "Vendas", value: 34, width: "18%" },
];
